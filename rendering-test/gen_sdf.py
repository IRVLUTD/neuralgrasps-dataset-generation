...
parser.add_argument('-o', '--path_out', type=str, default='/home/ninad/Desktop/multi-finger-grasping/docker-data/output_dataset/',
...
def main(args):
    ...
    for model in models:
        ...
        sdf_folder = os.path.join(args.path_out, model, 'sdf', gripper_name)
        ...
        normalization_file = os.path.join(args.path_out, model, "norm_params.npz")
